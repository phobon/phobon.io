...
<FigureGrid caption="Initial explorations and high-level sketches on paper">
  <Picture
    width="100%"
    src="/writing/aligning-agworlds-platform-experiences/sketch1"
    alt="Paddock selector exploration and layout"
  />
  <Picture
    width="100%"
    src="/writing/aligning-agworlds-platform-experiences/sketch2"
...
<FigureGrid caption="Working through initial concepts with product managers and structural elements with developers on whiteboard">
  <Picture
    width="100%"
    src="/writing/aligning-agworlds-platform-experiences/03"
    alt="Paddock inspector mockup"
    gridArea={["auto", "1 / 1 / span 1 / span 2"]}
  />
  <Picture
    width="100%"
    src="/writing/aligning-agworlds-platform-experiences/01"
...
<FigureGrid caption="Some early, in-context work that shipped incrementally as part of the process">
  <Picture
    width="100%"
    src="/writing/aligning-agworlds-platform-experiences/inspector1"
    alt="Jobs on maps"
  />
  <Picture
    width="100%"
    src="/writing/aligning-agworlds-platform-experiences/inspector2"
    alt="Financial snapshot"
  />
  <Picture
    width="100%"
    src="/writing/aligning-agworlds-platform-experiences/inspector3"
    alt="Financial snapshot"
  />
</FigureGrid>
...
<Figure caption="The original web app experience">
  <Picture
    width="100%"
    src="/writing/aligning-agworlds-platform-experiences/web"
...
<Figure caption="The redesigned web app experience">
  <Picture
    width="100%"
    src="/writing/aligning-agworlds-platform-experiences/new_web"
...
<FigureGrid caption="Insetting the panels, so they don't attach to the extremities of the map gives the illusion of space. Even though the panels are actually larger, they appear to float, reducing their impact on the overall experience">
  <Picture
    width="100%"
    src="/writing/aligning-agworlds-platform-experiences/new_paddocks"
    alt="Detail of the paddock selector"
  />
  <Picture
    width="100%"
    src="/writing/aligning-agworlds-platform-experiences/new_inspector"
