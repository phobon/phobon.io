...
<FigureGrid
  ...
  <Image width="100%" src="/static/writing/aligning-agworlds-platform-experiences/sketch1.webp" alt="Paddock selector exploration and layout" />
  <Image width="100%" src="/static/writing/aligning-agworlds-platform-experiences/sketch2.webp" alt="Paddock inspector exploration" />
</FigureGrid>
...
<FigureGrid
  ...
  <Image width="100%" src="/static/writing/aligning-agworlds-platform-experiences/03.webp" alt="Paddock inspector mockup" gridArea={["auto", "1 / 1 / span 1 / span 2"]} />
  <Image width="100%" src="/static/writing/aligning-agworlds-platform-experiences/01.webp" alt="Whiteboard concepts" gridArea={["auto", "1 / 3 / span 1 / span 3"]} />
</FigureGrid>
...
<FigureGrid
  ...
  <Image width={['100%', 'auto']} src="/static/writing/aligning-agworlds-platform-experiences/inspector1.webp" alt="Jobs on maps" />
  <Image width={['100%', 'auto']} src="/static/writing/aligning-agworlds-platform-experiences/inspector2.webp" alt="Financial snapshot" />
  <Image width={['100%', 'auto']} src="/static/writing/aligning-agworlds-platform-experiences/inspector3.webp" alt="Financial snapshot" />
</FigureGrid>
...
<Figure caption="The original web app experience">
  <Image width="100%" src="/static/writing/aligning-agworlds-platform-experiences/web.webp" alt="Original Agworld on web" />
</Figure>

---

<Figure caption="The redesigned web app experience">
  <Image width="100%" src="/static/writing/aligning-agworlds-platform-experiences/new_web.webp" alt="Redesigned Agworld on web" />
</Figure>
...
<FigureGrid
  ...
  <Image width={["100%", 'auto']} src="/static/writing/aligning-agworlds-platform-experiences/new_paddocks.webp" alt="Detail of the paddock selector" />
  <Image width={["100%", 'auto']} src="/static/writing/aligning-agworlds-platform-experiences/new_inspector.webp" alt="Detail of the paddock inspector" />
</FigureGrid>
