...
import { Picture, Figure, FigureGrid, Meta } from '@/components';

<Meta
  description="Aligning Agworld's Platform Experiences"
  url="https://phobon.io/writing/aligning-agworlds-platform-experiences"
  image="https://phobon.io/static/writing/aligning-agworlds-platform-experiences/index.webp" />
...
<FigureGrid
  ...
  <Picture width="100%" src="/static/writing/aligning-agworlds-platform-experiences/sketch1" alt="Paddock selector exploration and layout" />
  <Picture width="100%" src="/static/writing/aligning-agworlds-platform-experiences/sketch2" alt="Paddock inspector exploration" />
</FigureGrid>

<FigureGrid
  caption="Working through initial concepts with product managers and structural elements with developers on whiteboard">
  <Picture width="100%" src="/static/writing/aligning-agworlds-platform-experiences/03" alt="Paddock inspector mockup" gridArea={["auto", "1 / 1 / span 1 / span 2"]} />
  <Picture width="100%" src="/static/writing/aligning-agworlds-platform-experiences/01" alt="Whiteboard concepts" gridArea={["auto", "1 / 3 / span 1 / span 3"]} />
</FigureGrid>
...
<FigureGrid
  ...
  <Picture width="100%" src="/static/writing/aligning-agworlds-platform-experiences/inspector1" alt="Jobs on maps" />
  <Picture width="100%" src="/static/writing/aligning-agworlds-platform-experiences/inspector2" alt="Financial snapshot" />
  <Picture width="100%" src="/static/writing/aligning-agworlds-platform-experiences/inspector3" alt="Financial snapshot" />
</FigureGrid>
...
<Figure caption="The original web app experience">
  <Picture width="100%" src="/static/writing/aligning-agworlds-platform-experiences/web" alt="Original Agworld on web" />
</Figure>

---

<Figure caption="The redesigned web app experience">
  <Picture width="100%" src="/static/writing/aligning-agworlds-platform-experiences/new_web" alt="Redesigned Agworld on web" />
</Figure>
...
<FigureGrid
  ...
  <Picture width="100%" src="/static/writing/aligning-agworlds-platform-experiences/new_paddocks" alt="Detail of the paddock selector" />
  <Picture width="100%" src="/static/writing/aligning-agworlds-platform-experiences/new_inspector" alt="Detail of the paddock inspector" />
</FigureGrid>
