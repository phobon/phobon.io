...
import { Picture, Figure, FigureGrid, ImageGrid, Meta } from '../../../components';
...
<Meta
  ...
  image="https://phobon.io/static/writing/building-a-better-buying-experience-at-agworld/index.webp" />
...
<Figure caption="A rough moodboard">
  <Picture width="100%" src="/static/writing/building-a-better-buying-experience-at-agworld/moodboard" alt="An array images used for inspiration" />
</Figure>
...
<Figure width="100%" caption="The original experience">
  <Picture width="100%" src="/static/writing/building-a-better-buying-experience-at-agworld/old_agworld_cart" alt="The original shopping experience" />
</Figure>

---

<Figure width="100%" caption="A rapidly-developed prototype with prices obfuscated">
  <Picture width="100%" src="/static/writing/building-a-better-buying-experience-at-agworld/prototype_1" alt="A rapidly-developed prototype of a new shopping experience with prices obfuscated" />
</Figure>
...
<Figure width="100%" caption="Choosing a subscription with prices obfuscated">
  <Picture width="100%" src="/static/writing/building-a-better-buying-experience-at-agworld/prototype_2" alt="Prototype iterations with prices obfuscated" />
</Figure>
...
<Figure width="100%" caption="Refining and iterating on a theme and aesthetic with prices obfuscated">
  <Picture width="100%" src="/static/writing/building-a-better-buying-experience-at-agworld/iteration_1" alt="A summary view of the refined shopping experience and a detail view of a subscription card with prices obfuscated" />
</Figure>

---

<FigureGrid
  caption="Some of the many iterations and tests on prototypes with prices obfuscated">
  <Picture width="100%" fallbackExtension="png" fallbackType="png" src="/static/writing/building-a-better-buying-experience-at-agworld/iteration_2" alt="An array of iterations of the refined shopping experience with prices obfuscated" />
</FigureGrid>

---

<FigureGrid
  caption="Trying to find a balance in layout with prices obfuscated">
  <Picture width="100%" fallbackExtension="png" fallbackType="png" src="/static/writing/building-a-better-buying-experience-at-agworld/iteration_3" alt="Sliced images of different layout options for subscription cards with prices obfuscated" />
</FigureGrid>
...
<FigureGrid
  ...
  <Picture width="100%" src="/static/writing/building-a-better-buying-experience-at-agworld/iteration_4" alt="Refined shopping experience with subscription cards" />
</FigureGrid>

---

<Figure caption="The final, polished experience">
  <Picture width="100%" src="/static/writing/building-a-better-buying-experience-at-agworld/final" alt="Final shipped experience with subscription cards" />
</Figure>
...
<Figure caption="The redesigned experience">
  <video style={{ width: '100%' }} autoPlay="autoplay" loop="loop" muted="muted" playsInline="playsinline">
    <source src="/static/writing/building-a-better-buying-experience-at-agworld/cart.webm" type="video/webm" />
  </video>
</Figure>
