...
<Figure caption="Significant, blocking resources">
  <Picture
...
<Figure caption="Removing resources">
  <Picture
...
The last really important step in this effort was to consolidate the three vastly different layouts into one single experience.
