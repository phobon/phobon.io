...
- As the web product was built to be viewed only on a large monitor, customers with Android devices often felt that they were being ignored
...
- Discussed ideas around React Native
- Android Native
