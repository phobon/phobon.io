...
<FigureGrid
  caption="A selection of initial sketches on paper">
  <Image width="100%" src="/static/studies/aligning-agworld-platform-experience/02.png" alt="Original concepts mockup" />
  <Image width="100%" src="/static/studies/aligning-agworld-platform-experience/03.png" alt="Paddock inspector mockup" />
</FigureGrid>

<FigureGrid
  caption="Working through higher-level concepts with the team "
  ...
  <Image width="100%" src="/static/studies/aligning-agworld-platform-experience/03.png" alt="Paddock inspector mockup" gridArea={["auto", "1 / 3 / span 1 / span 1"]} />
</FigureGrid>
