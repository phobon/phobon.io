...
<FigureGrid
  ...
  <Image width="100%" src="/static/studies/aligning-agworld-platform-experiences/sketch1.png" alt="Paddock selector exploration and layout" />
  <Image width="100%" src="/static/studies/aligning-agworld-platform-experiences/sketch2.png" alt="Paddock inspector exploration" />
</FigureGrid>
...
<FigureGrid
  ...
  <Image width="100%" src="/static/studies/aligning-agworld-platform-experiences/03.png" alt="Paddock inspector mockup" gridArea={["auto", "1 / 1 / span 1 / span 2"]} />
  <Image width="100%" src="/static/studies/aligning-agworld-platform-experiences/01.png" alt="Whiteboard concepts" gridArea={["auto", "1 / 3 / span 1 / span 3"]} />
</FigureGrid>
...
<FigureGrid
  ...
  <Image width={['100%', 'auto']} src="/static/studies/aligning-agworld-platform-experiences/inspector1.png" alt="Jobs on maps" />
  <Image width={['100%', 'auto']} src="/static/studies/aligning-agworld-platform-experiences/inspector2.png" alt="Financial snapshot" />
  <Image width={['100%', 'auto']} src="/static/studies/aligning-agworld-platform-experiences/inspector3.png" alt="Financial snapshot" />
</FigureGrid>
...
<Figure caption="The original web app experience">
  <Image width="100%" src="/static/studies/aligning-agworld-platform-experiences/web.jpg" alt="Original Agworld on web" />
</Figure>

---

<Figure caption="The redesigned web app experience">
  <Image width="100%" src="/static/studies/aligning-agworld-platform-experiences/new_web.png" alt="Redesigned Agworld on web" />
</Figure>
...
<FigureGrid
  ...
  <Image width={["100%", 'auto']} src="/static/studies/aligning-agworld-platform-experiences/new_paddocks.png" alt="Detail of the paddock selector" />
  <Image width={["100%", 'auto']} src="/static/studies/aligning-agworld-platform-experiences/new_inspector.png" alt="Detail of the paddock inspector" />
</FigureGrid>
