import { Picture, Figure, FigureGrid } from '@/components/markdown'
...
<Meta
  ...
  image='https://phobon.io/writing/aligning-agworlds-platform-experiences/index.webp'
/>
...
<FigureGrid caption='Initial explorations and high-level sketches on paper'>
  <Picture
    src='/writing/aligning-agworlds-platform-experiences/sketch1.webp'
    alt='Paddock selector exploration and layout'
    width={640}
    height={854}
  />
  <Picture
    src='/writing/aligning-agworlds-platform-experiences/sketch2.webp'
    alt='Paddock inspector exploration'
    width={640}
    height={854}
  />
</FigureGrid>

<FigureGrid caption='Working through initial concepts with product managers and structural elements with developers on whiteboard'>
  <Picture
    src='/writing/aligning-agworlds-platform-experiences/03.webp'
    alt='Paddock inspector mockup'
    gridArea={['auto', '1 / 1 / span 1 / span 2']}
    width={593}
    height={380}
  />
  <Picture
    src='/writing/aligning-agworlds-platform-experiences/01.webp'
    alt='Whiteboard concepts'
    gridArea={['auto', '1 / 3 / span 1 / span 3']}
    width={917}
    height={434}
  />
</FigureGrid>
...
<FigureGrid caption='Some early, in-context work that shipped incrementally as part of the process'>
  <Picture
    src='/writing/aligning-agworlds-platform-experiences/inspector1.webp'
    alt='Jobs on maps'
    width={287}
    height={568}
  />
  <Picture
    src='/writing/aligning-agworlds-platform-experiences/inspector2.webp'
    alt='Financial snapshot'
    width={287}
    height={568}
  />
  <Picture
    src='/writing/aligning-agworlds-platform-experiences/inspector3.webp'
    alt='Financial snapshot'
    width={287}
    height={568}
  />
...
<Figure caption='The original web app experience'>
  <Picture
    src='/writing/aligning-agworlds-platform-experiences/web.webp'
    alt='Original Agworld on web'
    width={1280}
    height={692}
  />
</Figure>
...
<Figure caption='The redesigned web app experience'>
  <Picture
    src='/writing/aligning-agworlds-platform-experiences/new_web.webp'
    alt='Redesigned Agworld on web'
    width={1280}
    height={1268}
  />
</Figure>
...
<FigureGrid caption="Insetting the panels, so they don't attach to the extremities of the map gives the illusion of space. Even though the panels are actually larger, they appear to float, reducing their impact on the overall experience">
  <Picture
    src='/writing/aligning-agworlds-platform-experiences/new_paddocks.webp'
    alt='Detail of the paddock selector'
    width={416}
    height={582}
  />
  <Picture
    src='/writing/aligning-agworlds-platform-experiences/new_inspector.webp'
    alt='Detail of the paddock inspector'
    width={416}
    height={582}
  />
</FigureGrid>
