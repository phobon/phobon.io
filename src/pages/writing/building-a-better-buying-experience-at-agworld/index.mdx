import { Picture, Figure, FigureGrid, ImageGrid } from '@/components/markdown'
...
<ImageGrid>
  <Figure caption='Exploring basic layout options'>
    <Picture
  ...
  <Figure caption='Deeper dive into payment forms'>
    <Picture
