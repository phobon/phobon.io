...
import { Vector, Box, BoxProps } from '@/components/v6/Base/Core'

export type IdentityProps = BoxProps & React.HTMLAttributes<HTMLDivElement> & { as?: React.ElementType }

export const Identity = React.forwardRef<HTMLDivElement, IdentityProps>((props, ref) => (
  <Box {...props} ref={ref} css={{ cursor: 'pointer' }}>
    <Vector
      width='100%'
      height='100%'
      viewBox='0 0 16 16'
