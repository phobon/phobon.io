...
const experiences = [{
  ...
  description: 'Driving & scaling design through making Design Systems; designing thoughtful, accessible digital experiences; & mentoring others in design & front-end development',
  achievements: [
    'Achievement 1',
    'Achievement 2',
    'Achievement 3',
...
export const withVaryingTextLengths = () => (
  <Stack fullWidth space={6}>
    {experiences.map(({ key, ...s }) => <Experience key={key} {...s} />)}
  </Stack>
);
