...
const studies = [
  {
    ...
    category: "Agworld",
    description:
      "Improving the experience of buying subscriptions for Agworld's customers",
  ...
  },
  {
    ...
    category: "Agworld",
    description:
      "Helping to align Agworld's web product and its highly rated and widely adopted mobile apps",
